...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'prassu1402@gmailcom' ")
...
message3 = tk.Label(window, text="KIET Attendance System" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
